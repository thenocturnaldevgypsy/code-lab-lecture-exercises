...
public class DataStrucAlgoAnalysis {
  public static void main(String[] args) {
    ...
    while (runningDSAA) {
      ...
      System.out.println("| 3 | All Activities under Prefinals Period");
      ...
      // Handle non-integer inputs - start
      try {
      ...
      // Handle non-integer inputs - end

      switch (choiceDSAA) {
        
        //show menu for all prelim activities - start
        case 1 -> {
        ...
        //show menu for all prelim activities - end

        //show menu for all midterm activities - start
        case 2 -> {
        ...
        //show menu for all midterm activities - end

        //show menu for all prefinals activities - start
        case 3 -> {
        ...
        //show menu for all prefinals activities - end

        //show menu for all finals activities - start
        case 4 -> {
          ...
          while (runningFinal) {
            ...
            if (choiceFinal.equals("E")) { // if user choose E - Exercises

              // Placeholder for Exercises selection
              boolean runningFinalExercise = true;

              //for continuously showing exercises list until exited - start
              while (runningFinalExercise) {
                ...
                //running the selected exercise - start
              ...
              //for continuously showing exercises list until exited - end
        ...
        //show menu for all finals activities - end

        //show menu for individual summary notes activities - start
        case 5 -> {
          System.out.println();
        ...
        //show menu for individual summary notes activities - end

        //quit the program - start
        case 0 -> {
          runningDSAA = false;
          System.out.println("\nGoodbye!");
        }
